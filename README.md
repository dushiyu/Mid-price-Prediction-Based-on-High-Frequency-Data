...
<p>Transform the data into market depth view, and estimate the sizes of market, limit and cancelled orders.

2. [q/kdb+]Data Preparation in Q.ipynb

<p>Data preprocessing and part of feature engineering.
